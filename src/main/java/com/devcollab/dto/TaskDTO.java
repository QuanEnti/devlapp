...
public class TaskDTO {
        ...
        public static TaskDTO fromEntity(Task task) {
                ...
                return TaskDTO.builder().id(task.getTaskId()).title(task.getTitle())
                                ...
                                .startDate(task.getStartDate() != null
                                                ? task.getStartDate().format(iso)
                                                : "")
                                .endDate(task.getDeadline() != null ? task.getDeadline().format(iso)
                                                : "")

                                .creatorName(task.getCreatedBy() != null
                                ...
                                .assigneeAvatar(task.getAssignee() != null
                                                ...
                                                : null)
                                .creatorId(task.getCreatedBy() != null
                                ...
                                .assignees(task.getFollowers() != null && !task.getFollowers()
                                                .isEmpty() ? task
                                                                .getFollowers().stream()
                                                                .map(f -> new AssigneeDTO(f
                                                                                .getUser()
                                                                                .getUserId(),
                                                                                f.getUser().getName(),
                                                                ...
                                                                .collect(Collectors.toMap(
                                                                                AssigneeDTO::getUserId,
                                                                                dto -> dto,
                                                                                (existing, replacement) -> existing // Giữ
                                                                                                                    // lại
                                                                                                                    // phần
                                                                                                                    // tử
                                                                                                                    // đầu
