...
public interface TaskRepository extends JpaRepository<Task, Long> {
    ...
    @Query("""
            ...
            """)
    List<Object[]> countCompletedTasksPerDay(@Param("projectId") Long projectId,
    ...
    @Query("""
            ...
            """)
    List<Task> findByProject_ProjectIdAndArchivedFalseWithFollowers(
    ...
    @Query("""
            ...
            ORDER BY CASE WHEN t.deadline IS NULL THEN 1 ELSE 0 END,
                     t.deadline ASC
            """)
    Page<Task> findUserTasksByStatus(@Param("user") User user, @Param("status") String status,
            Pageable pageable);
    ...
    Page<Task> findByProject_ProjectIdAndTitleContainingIgnoreCase(Long projectId, String title,
            Pageable pageable);
