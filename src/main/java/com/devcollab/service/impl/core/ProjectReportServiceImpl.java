...
public class ProjectReportServiceImpl implements ProjectReportService {
    ...
    public Map<String, Object> getAllReports(int page, int size) {
        ...
        List<ProjectReportDto> content = reportPage.getContent()
                .stream()
    ...
    public ProjectReport updateReport(Long id, Map<String, String> body, User admin) {
        ...
        ProjectReport report = reportRepo.findById(id)
                .orElseThrow(() -> new RuntimeException("Project report not found"));
    ...
    public void warnOwner(Long id, Map<String, String> body, User admin) {
        ...
        n.setType("WARNING");
        n.setReferenceId(id);
        n.setMessage("⚠️ Your project " +project.getName()+" receive a warning: "+ message);
        n.setStatus("unread");
    ...
    public void removeProject(Long id, User admin) {
        ...
        n.setType("BAN");
        n.setReferenceId(id);
        n.setMessage("🚫 Your project \"" + project.getName() + "\" has been removed due to violations.");
        n.setStatus("unread");
        n.setCreatedAt(java.time.LocalDateTime.now());
        n.setLink("/view/project-report/" + id);
        notificationRepo.save(n);
    ...
    public ProjectReportDto getReportById(Long id) {
        ProjectReport report = reportRepo.findById(id)
                .orElseThrow(() -> new NotFoundException("Project report not found with id: " + id));
